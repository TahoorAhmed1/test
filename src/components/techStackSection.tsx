    ...
    <div className="tree hidden lg:block">
      <ul className="flex items-center justify-center relative">
        <li className="relative">
          <a
            href="#"
            className="rounded-2xl text-lg text-[#00CE44] border-3 border-[#282727] bg-[#151515] px-3 py-2 w-[200px]"
          >
            Start
          </a>
          ...
          <ul className="pt-26 flex">
            <li className="relative px-10 pt-20">
              <a
                href="#"
                className="rounded-2xl text-lg text-[#00CE44] border-3 border-[#282727] bg-[#151515] px-3 py-2 w-[200px]"
              >
              ...
              <ul className="">
                <li className="relative px-10 pt-26">
                  <a
                    href="#"
                    className="rounded-2xl text-lg text-[#00CE44] border-3 border-[#282727] bg-[#151515] px-3 py-2 w-[200px] gap-2 flex items-center"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 45 45" fill="none">
                      <path
                        d="M22.586 15.8013L17.8018 7.60449L3.44824 7.60449L22.586 40.3919L41.7237 7.60449L27.3702 7.60449L22.586 15.8013Z"
                        fill="#005C1E"
                      ></path>
                      <path
                        d="M27.3699 7.60449L22.5856 15.8013L17.8014 7.60449L10.8906 7.60449L22.5856 27.6413L34.2807 7.60449L27.3699 7.60449Z"
                        fill="#00CE44"
                      ></path>
                    </svg>
                    Vue.js
            ...
            <li className="relative px-10 pt-28">
              <a
                href="#"
                className="rounded-2xl text-lg text-[#00CE44] border-3 border-[#282727] bg-[#151515] px-3 py-2 w-[200px]"
              >
                ...
                <li className="relative px-10 pt-20">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 36 29" fill="none">
                      <path
                        d="M30.9464 10.6802C30.2443 8.1728 28.8345 5.96504 26.942 4.27734L22.7545 8.46516C24.2817 9.7084 25.3118 11.5382 25.4994 13.6093V14.9828C25.5231 14.9828 25.5449 14.9755 25.5686 14.9755C27.6833 14.9755 29.4046 16.6969 29.4046 18.8118C29.4046 20.9266 27.6833 22.6489 25.5686 22.6489C25.5449 22.6489 25.5231 22.6426 25.4994 22.6416V22.6489H19.4285H18.0205V28.5691H25.4994V28.5654C25.5231 28.5654 25.5449 28.5691 25.5686 28.5691C30.9483 28.5691 35.3243 24.1918 35.3243 18.8127C35.3243 15.42 33.5812 12.4289 30.9464 10.6802Z"
                        fill="#00CE44"
                      ></path>
                      <path
                        opacity="0.5"
                        d="M13.977 17.2668L18.2756 12.9679C18.272 12.9633 18.2683 12.9597 18.2656 12.9561L13.9697 17.2523C13.9715 17.2568 13.9743 17.2614 13.977 17.2668Z"
                        fill="#00CE44"
                      ></path>
                      <path
                        opacity="0.5"
                      ...
                      ></path>
                      <path
                        d="M18.0201 0.859375C10.6132 0.859375 4.58691 6.88608 4.58691 14.2936C4.58691 14.5058 4.60877 14.7125 4.61879 14.922L10.5385 14.922C10.5212 14.7143 10.5066 14.5058 10.5066 14.2936C10.5066 10.1504 13.8772 6.77952 18.0201 6.77952C19.8133 6.77952 21.4608 7.41343 22.7541 8.4654L26.9416 4.27758C24.5664 2.15908 21.4454 0.859375 18.0201 0.859375Z"
                        fill="#00CE44"
                      ></path>
                      <path
                        opacity="0.5"
                        d="M10.4726 22.6493H10.4707C9.9143 22.6493 9.38881 22.5245 8.91159 22.3096L4.62207 26.5994C6.255 27.8299 8.27681 28.5694 10.4707 28.5694H10.4726H18.0207V22.6493L10.4726 22.6493Z"
                        fill="#00CE44"
                      ></path>
                      <path
                        d="M10.4726 22.6493H10.4707C9.9143 22.6493 9.38881 22.5245 8.91159 22.3096L4.62207 26.5994C6.255 27.8299 8.27681 28.5694 10.4707 28.5694H10.4726H18.0207V22.6493L10.4726 22.6493Z"
                      ...
                      ></path>
                      <path
                        d="M6.63651 18.8151C6.63651 16.7021 8.35778 14.9807 10.4707 14.9807C12.0216 14.9807 13.365 15.9124 13.9688 17.2522L18.2647 12.956C16.4787 10.5861 13.6518 9.06055 10.4698 9.06055C5.09739 9.06055 0.716797 13.4323 0.716797 18.8151C0.716797 21.9947 2.25683 24.8172 4.62199 26.5997L8.9115 22.3098C7.57456 21.7105 6.63651 20.3717 6.63651 18.8151Z"
                        fill="#00CE44"
                      ></path>
                    </svg>
                    G Cloud
                          ...
                          <defs>
                            <clipPath id="clip0_238_740">
                              <rect
                                ...
                                height="43.7162"
                                fill="white"
                                transform="translate(0.791992 0.935547)"
                              ></rect>
                            </clipPath>
                          </defs>
                        </svg>
        ...
        <div className="text-white pt-10 lg:pt-0 pb-8 px-4 lg:px-8 xl:px-12 mt-[-50px] relative z-10">
          <div className="flex flex-col lg:flex-row gap-10">
            <div className="w-full lg:w-2/5 shrink">
              <div
                className="bg-gradient01 row-span-3 rounded-4xl p-10"
                style={{ background: "linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 100%)" }}
              >
                <h1 className="text-3xl md:text-5xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-20">
                  Always Evolving with Next-Gen Technologies!
                </h1>
                <p>
                  From backend APIs to intuitive mobile interfaces, our tech stack is carefully chosen to bring your app
                  vision to life.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-3/5 flex flex-col gap-10">
              <div
                className="bg-gradient01 flex gap-2 justify-between rounded-4xl p-10"
                style={{ background: "linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 100%)" }}
              >
              ...
              <div
                className="bg-gradient01 flex flex-wrap gap-10 md:gap-1 justify-evenly items-center rounded-4xl py-10"
                style={{ background: "linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 100%)" }}
              >
                <Link href="">
                  <Image src="/appstore-editor-choice.png" alt="App Store Editor's Choice" width={134.67} height={70} />
                </Link>
                <Link href="">
                  <Image src="/app-of-the-day.png" alt="App of the Day" width={134.67} height={70} />
                </Link>
                <Link href="">
                  <Image src="/microsoft.png" alt="Microsoft" width={134.67} height={70} />
                </Link>
                <Link href="">
                  <Image src="/the-webby.png" alt="The Webby Awards" width={134.67} height={70} />
                </Link>
              </div>
            </div>
          </div>
